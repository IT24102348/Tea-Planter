                ...
                <div className="relative pt-48 pb-32 px-6 md:px-12 lg:px-20 flex-grow flex items-center justify-center">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-gray-900 mb-8">
                            Build the future of AgTech.
                        </h1>
                        <p className="text-xl text-gray-600 leading-relaxed mb-12">
                            We are hackers, domain experts, and dreamers looking for brilliant minds to optimize agriculture worldwide. Check our open engineering and sales roles.
                        </p>
                    </div>
                </div>
