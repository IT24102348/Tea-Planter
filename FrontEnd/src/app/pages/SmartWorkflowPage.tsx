...
export function SmartWorkflowPage() {
    return (
                ...
                <div className="relative pt-48 pb-32 px-6 md:px-12 lg:px-20 flex-grow flex items-center justify-center">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl text-gray-600 leading-relaxed mb-12">
                            Automate attendance, shift dynamic assignments, and payroll. Manage thousands of workers with ease and real-time accuracy. Get unprecedented visibility into your daily operations.
                        </p>
                    </div>
                </div>
