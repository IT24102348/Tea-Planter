...
const navItems: NavItem[] = [
  ...
  { to: '/financial', icon: DollarSign, labelKey: 'financial', roles: ['owner'] },
  { to: '/worker-financial', icon: DollarSign, labelKey: 'financial', roles: ['worker', 'clerk'] },
    ...
    <>
      ...
      <div className="md:hidden w-full h-16 bg-white border-b border-gray-200 flex-shrink-0 flex items-center justify-between px-4 z-40 relative">
        <div className="flex items-center gap-2">
          <img src="/src/app/assets/TeaPlanterLogo3.png" alt="Logo" className="w-16 h-16 object-contain" />
